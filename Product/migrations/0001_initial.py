    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Insert Slug name', verbose_name='Slug')),
                ('parent', models.ForeignKey(blank=True, help_text='choose parent category', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='Product.category', verbose_name='Category')),
            ],
            options={
