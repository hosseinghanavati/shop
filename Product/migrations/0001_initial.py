    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Insert Slug name', max_length=200, unique=True, verbose_name='Slug')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Insert Slug name', max_length=200, verbose_name='Slug')),
                ('is_sub', models.BooleanField(default=False)),
                ('sub_category', models.ForeignKey(blank=True, help_text='choose parent category', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subCategory', to='Product.category', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='provide some description for this product', max_length=200, null=True, verbose_name='Description')),
                ('slug', models.SlugField(help_text='Insert Slug name', max_length=200, unique=True, verbose_name='Slug')),
                ...
                ('category', models.ManyToManyField(help_text='choose category of product', related_name='products', to='Product.Category', verbose_name='Category')),
                ('discount', models.ForeignKey(blank=True, help_text='choose the discount', null=True, on_delete=django.db.models.deletion.CASCADE, to='Product.discount', verbose_name='Discount')),
            ],
            options={
                'ordering': ('name',),
            },
